...
#define ACEGRID_VPV                                                           \
  (ACEGRID_STATUS | SIG_WORD | SIG_OFF0 | SIG_DECI | SIG_UINT)
#define ACEGRID_PPV                                                           \
  (ACEGRID_STATUS | SIG_WORD | SIG_OFF2 | SIG_UNIT | SIG_UINT)

#define ACEGRID_VLIMIT                                                         \
  (ACEGRID_CONFIG | SIG_WORD | SIG_OFF0 | SIG_MILL | SIG_UINT)


#define ACEGRID_NAMES  {"Vgt", ACEGRID_VPV}, { "Pgt", ACEGRID_PPV }
